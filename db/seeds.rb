...
# Actor.create(first_name: "Betty", last_name: "White", known_for: "The Golden Girls")

# Actor.create(first_name: "Steve", last_name: "Carell", known_for: "The Office")

# Actor.create(first_name: "Julia", last_name: "Louis-Dreyfus", known_for: "Seinfeld")
